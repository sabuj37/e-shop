                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                      <li class="active">
                          <a href="" class="svg-icon">                        
                              ...
                              <span class="ml-4">Dashboards hasnt</span>
                          </a>
                      </li>
                      <li class=" ">
                          <a href="#product" class="collapsed" data-toggle="collapse" aria-expanded="false">
                              ...
                              <span class="ml-4">Customer and Supplier</span>
                      ...
                      <li class=" ">
                          ...
                          <ul id="otherpage" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                  <li class=" ">
                                      <a href="#user"
                                        class="collapsed" data-toggle="collapse" aria-expanded="false">
                                      ...
                                      <ul id="user" class="iq-submenu collapse" data-parent="#otherpage">
                                              ...
                                              <li class="">
                                                  <a href="https://templates.iqonic.design/eshop/html/app/user-list.html">
                                          ...
                                          <div class="card-body p-0 text-center">
                                              ...
                                              <div class="p-3">
                                                  ...
                                                  <div class="d-flex align-items-center justify-content-center mt-3">
                                                      <a href="https://templates.iqonic.design/eshop/html/app/user-profile.html" class="btn border mr-2">Profile</a>
