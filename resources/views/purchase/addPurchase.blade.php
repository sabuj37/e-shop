@extends('include') 
@section('backTitle') purchase   @endsection @section('container')
<div class="row">
    <div class="col-sm-9">
        <div class="card">
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive     rounded mb-3">
                    <table class="data-tables table mb-0 tbl-server-info table-bordered">
                    ...
                    <tbody class="ligth-body">
                        <tr>
                            ...
                            <td>
                    <button type="reset" class="btn btn-success btn-sm">Add</button></td>
                            <td>1 year</td>
                            <td>12</td>
                            <td>10000</td>
                            <td>10%</td>
